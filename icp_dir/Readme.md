...
https://zhuanlan.zhihu.com/p/2032861425526419630
...
对应文件：5_icp_p2p_svd.cpp

+ 使用目标点云构造kd-tree
+ 遍历源点云中的每一个点，调用kd-tree对应的nearestKSearch最近邻搜索算法，寻找最匹配的k个点，输出为k个最近点在kd-tree点云中的index序号和对应的两个点之间的距离。
+ 两组点云的匹配点对获取后，使用SVD求解
  + 

### 高斯牛顿解最小二乘法，最小化点线残差或点面残差
